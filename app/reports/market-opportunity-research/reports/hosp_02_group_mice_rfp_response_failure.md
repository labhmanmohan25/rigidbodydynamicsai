...
**Estimated total MICE market and revenue at risk: $330-450B globally; $50-80B in leaked/lost hotel revenue from unanswered RFPs**

### A. Global MICE Market Size
- **Global MICE industry size (2024):** Estimated at **$805-876 billion** according to Allied Market Research and Grand View Research reports published in 2023-2024. Allied Market Research projected the MICE market to reach **$1.78 trillion by 2032**, growing at a CAGR of ~9.1% from 2023.
...
- **Average group booking revenue per event:** Ranges from **$15,000 for small meetings** to **$500,000+ for large conventions**. The weighted average across all group RFPs is approximately **$40,000-$60,000** per booking (Knowland, Cvent marketplace data).
...
- **Revenue lost per unanswered RFP:** At an average booking value of $40,000-$60,000 and a typical conversion rate of 10-15% for responded RFPs:
  - If 60% of 4M RFPs go unanswered = **2.4 million unanswered RFPs**
  - At a 12% conversion rate and $50K average value = **$14.4 billion in lost revenue potential (US alone)**
...
- A typical full-service hotel (300+ rooms) employs **3-8 group sales managers** at an average salary of **$55,000-$85,000** plus commissions.
- For a 500-room convention hotel, total group sales team cost (salaries + benefits + T&E) is **$500K-$1.5M/yr**.
...
|---|---|---|
| Small corporate meeting (10-30 rooms) | $15,000-$40,000 | 20-60 |
| Mid-size conference (50-150 rooms) | $75,000-$250,000 | 150-450 |
| Large convention (300+ rooms) | $250,000-$2,000,000+ | 600-3,000+ |
| Incentive travel group | $100,000-$500,000 | 200-500 |
| **Weighted average across all RFPs** | **$40,000-$60,000** | **80-150** |
...
|---|---|---|
| **Amadeus Delphi (S&C system)** | $15,000-$50,000/property/yr | Nearly universal at full-service hotels |
| **Cvent Supplier Network subscription** | $10,000-$30,000/property/yr | Access to inbound RFP flow |
| **Salesforce CRM (hospitality)** | $20,000-$100,000/yr per hotel company | Larger brands; per-user licensing |
| **IDeaS or Duetto (Revenue Management)** | $20,000-$60,000/property/yr | Group pricing optimization add-ons |
| **Groups360 GroupSync** | $10,000-$25,000/property/yr | Direct booking platform for groups |
| **Knowland (demand intelligence)** | $12,000-$36,000/property/yr | Meeting demand analytics |
| **Total software spend per full-service hotel** | **$75,000-$200,000/yr** | **For group sales technology stack** |

### B. Personnel Investment
- A single group sales manager costs **$70,000-$120,000/yr** fully loaded (salary + benefits + T&E).
- A large convention hotel may spend **$500K-$1.5M/yr** on group sales staff alone.
...
- **Cvent:** Went public via SPAC in 2021 at a $5.3B valuation. Acquired by Vista Equity Partners in 2023 for **$4.6 billion** -- the largest single investment in meetings/events technology.
...
- **Mews (hotel PMS):** Raised **$110M Series C** (2023) at $1.2B valuation, with group booking capabilities.
...
1. **MICE demand is surging post-pandemic** -- more RFPs are being generated than ever as in-person meetings rebound strongly.
2. **Hotel staffing has not recovered** -- the hospitality industry lost 30-40% of its workforce during COVID and has not fully rebuilt, meaning fewer sales managers are handling more RFPs.
3. **Planner expectations have increased** -- planners now expect faster, more digital, self-service experiences (influenced by consumer booking experiences), widening the gap between expectations and hotel capabilities.
4. **Group size fragmentation** -- more small-to-medium meetings (10-50 rooms) are being booked, increasing RFP volume but decreasing average value, making it even harder for sales teams to justify spending 3 hours on each response.
...
|---|---|---|---|
| **Cvent (Vista Equity)** | End-to-end meetings/events platform; Cvent Supplier Network is the dominant RFP distribution channel | **~$600-700M ARR** (2024 est.; was $560M at time of take-private in 2023) | Processes 2.5M+ hotel RFPs/yr; acquired Lanyon (hotel supplier side) in 2016 |
...
1. Allied Market Research. "MICE Industry Market Size, Share & Growth, 2032." https://www.alliedmarketresearch.com/MICE-industry-market
2. Grand View Research. "MICE Market Size & Trends Analysis Report." https://www.grandviewresearch.com/industry-analysis/mice-market-report
3. GBTA. "Business Travel Index Outlook 2024." https://www.gbta.org/research-tools/business-travel-index/
4. Mordor Intelligence. "MICE Tourism Market - Growth, Trends, and Forecasts." https://www.mordorintelligence.com/industry-reports/mice-tourism-market

### Hotel Industry Data
5. AHLA (American Hotel & Lodging Association). "State of the Hotel Industry 2024." https://www.ahla.com/sothi
6. STR/CoStar. "US Hotel Industry Performance Data." https://str.com/
7. AHLA. "Hotel Industry Workforce Data." https://www.ahla.com/workforce

### RFP Response & Planner Behavior
8. Cvent. "Planner Sourcing Report / Supplier Network Data." https://www.cvent.com/en/resource/planner-sourcing
9. MPI (Meeting Professionals International). "Meetings Outlook Survey 2024." https://www.mpi.org/research
10. PCMA (Professional Convention Management Association). "Business Events Industry Research." https://www.pcma.org/research/
11. Knowland. "Meeting Demand Analytics Reports." https://www.knowland.com/
12. Amadeus Hospitality. "Group Sales Benchmarking Data." https://www.amadeus-hospitality.com/

### Technology & Vendor Data
13. Cvent Investor Relations / Vista Equity acquisition details (2023). https://www.cvent.com/en/press-releases
14. Groups360 funding and partnerships. https://www.groups360.com/
15. Amadeus Delphi product information. https://www.amadeus-hospitality.com/delphi-sales-and-catering/
16. Tripleseat/SpotOn acquisition (2023). https://www.tripleseat.com/
17. Mews Series C funding (2023). https://www.mews.com/
18. Duetto Group Revenue Strategy. https://www.duettocloud.com/

### Event Technology Market
19. Verified Market Research. "Event Management Software Market." https://www.verifiedmarketresearch.com/product/event-management-software-market/
20. Fortune Business Insights. "Event Management Software Market Size." https://www.fortunebusinessinsights.com/event-management-software-market

### Industry Associations
21. APEX (Accepted Practices Exchange) / Events Industry Council. "APEX Standards." https://www.eventscouncil.org/
22. HSMAI (Hospitality Sales and Marketing Association International). "Group Sales Resources." https://www.hsmai.org/
23. IACC (International Association of Conference Centres). "Meeting Room of the Future Research." https://www.iacconline.org/

### Revenue Management for Groups
24. IDeaS Revenue Solutions. "Group Business Optimization." https://ideas.com/
25. Duetto. "Group Revenue Strategy Solutions." https://www.duettocloud.com/solutions/groups
...
| Field | Key Figure |
|---|---|
| **Problem Market Size** | Global MICE: $805-876B; Hotel group revenue: $70-90B (US); Revenue leaked from unanswered RFPs: $8-15B (US), $25-50B (global) |
| **Current Spend to Manage** | $20-30B/yr globally (software + personnel); Software alone: $3-5B |
| **Cost of Inaction** | $40-60K average booking value; 50-70% RFPs unanswered; $6K expected value per ignored RFP; $3M/yr lost per hotel; 62-70% planners eliminate slow responders |
...
| **Willingness to Pay** | $75K-200K/property/yr on group sales tech; $6-8B+ in VC/PE deployed in MICE tech; Major brands investing directly in Groups360 |
| **Market Growth** | MICE market: 9-10% CAGR; Group sales tech: 10-14% CAGR; AI-powered group automation: 25-35% CAGR (emerging) |
| **Key Players** | Cvent (~$600-700M rev), Amadeus/Delphi (~$200-300M), Groups360 (~$20-40M), Oracle Hospitality (~$1B+), Knowland, IDeaS, Duetto |

**This problem clearly exceeds the $10B threshold.** The MICE industry is massive ($800B+) and growing at ~9-10% CAGR, yet the hotel-side response infrastructure is stuck in the manual era. The core gap -- no AI system that can auto-generate a complete, multi-department group proposal within minutes -- represents a greenfield opportunity. With 50-70% of RFPs going unanswered and planners choosing based on response speed, an AI-powered RFP response tool that cuts response time from days to minutes could capture significant share of the $8-15B in leaked US hotel revenue alone. The willingness-to-pay signals are strong: hotels already spend $75-200K/yr per property on group sales tools, and the largest PE firm in software (Vista Equity) paid $4.6B for Cvent, validating the market's importance.
